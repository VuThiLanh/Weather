...
import com.lanh.weather.R
import com.lanh.weather.data.model.ForecastResponse.Current.Condition
import com.lanh.weather.model.Forecast
import com.lanh.weather.model.Hour
import com.lanh.weather.model.Weather
import com.lanh.weather.ui.theme.WeatherTheme
import com.lanh.weather.ui.weather.components.Animation
import com.lanh.weather.ui.weather.components.ForecastComponent
import com.lanh.weather.ui.weather.components.HourlyComponent
import com.lanh.weather.ui.weather.components.WeatherComponent
import com.lanh.weather.utils.DateUtil.toFormattedDate
        ...
        Animation(
            modifier =
                Modifier
                    .fillMaxWidth()
                    .weight(8f),
            animation = R.raw.error_animation,
        )
...
fun WeatherTopAppBar(
    ...
    when {
        uiState.errorMessage.isNotEmpty() || uiState.isLoading -> {
